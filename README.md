...
<!-- ===================================================== -->
![Código do Projeto](assets/codigo_setup.jpg)
...
│
├── 📂 assets/                         ← Coloque todas as imagens aqui
│   ├── codigo_setup.jpg               ← Imagem 1
│   ├── veredito_empirico.jpg          ← Imagem 2
│   ├── evolucao_producao.jpg          ← Imagem 3
│   ├── matriz_correlacao.jpg          ← Imagem 4
│   ├── dataset_preview.jpg            ← Imagem 5
│   ├── real_vs_previsto.jpg           ← Imagem 6
│   ├── epicentro_agronegocio.jpg      ← Imagem 7
│   ├── volatilidade_extrema.jpg       ← Imagem 8
│   ├── embate_metodologico.jpg        ← Imagem 9
│   └── conclusao.jpg                  ← Imagem 10
│
├── 📂 data/
│   ├── raw/
│   └── processed/
│       └── dados_agronegocio_brasil_tratados.csv
│
├── 📂 notebooks/
│   ├── 01_importacao_e_setup.ipynb
│   ├── 02_eda_visualizacoes.ipynb
│   ├── 03_engenharia_de_features.ipynb
│   ├── 04_modelos_tradicionais.ipynb
│   ├── 05_modelos_ml_deeplearning.ipynb
│   └── 06_comparativo_resultados.ipynb
│
├── 📂 src/
│   ├── data_loader.py
...
```bash
# Clone o repositório
git clone https://github.com/r4ffa12/previsao-soja-brasil.git

# Entre na pasta do projeto
cd previsao-soja-brasil
